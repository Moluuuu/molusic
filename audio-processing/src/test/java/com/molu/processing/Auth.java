...
public final class Auth {
    ...
    public static Auth create(String accessKey, String secretKey) {
        ...
        byte[] sk = com.qiniu.util.StringUtils.utf8Bytes(secretKey);
        SecretKeySpec secretKeySpec = new SecretKeySpec(sk, "HmacSHA1");
        return new Auth(accessKey, secretKeySpec);
    }

    private static void copyPolicy(final com.qiniu.util.StringMap policy, com.qiniu.util.StringMap originPolicy, final boolean strict) {
        if (originPolicy == null) {
            return;
        }
        originPolicy.forEach(new com.qiniu.util.StringMap.Consumer() {
            @Override
            public void accept(String key, Object value) {
                if (com.qiniu.util.StringUtils.inStringArray(key, deprecatedPolicyFields)) {
                    throw new IllegalArgumentException(key + " is deprecated!");
                }
                if (!strict || com.qiniu.util.StringUtils.inStringArray(key, policyFields)) {
    ...
    public String sign(String data) {
        return sign(com.qiniu.util.StringUtils.utf8Bytes(data));
    }

    @Deprecated // private
    public String signWithData(byte[] data) {
        String s = UrlSafeBase64.encodeToString(data);
        return sign(com.qiniu.util.StringUtils.utf8Bytes(s)) + ":" + s;
    }

    @Deprecated // private
    public String signWithData(String data) {
        return signWithData(com.qiniu.util.StringUtils.utf8Bytes(data));
    }
    ...
    public String signRequest(String urlString, byte[] body, String contentType) {
        ...
        mac.update(com.qiniu.util.StringUtils.utf8Bytes(path));

        if (query != null && query.length() != 0) {
            mac.update((byte) ('?'));
            mac.update(com.qiniu.util.StringUtils.utf8Bytes(query));
        }
        mac.update((byte) '\n');
    ...
    public String privateDownloadUrlWithDeadline(String baseUrl, long deadline) {
        ...
        b.append(deadline);
        String token = sign(com.qiniu.util.StringUtils.utf8Bytes(b.toString()));
        b.append("&token=");
        b.append(token);
        return b.toString();
    }
     ...
     * @return 生成的上传token
     */
    public String uploadToken(String bucket, String key, long expires, com.qiniu.util.StringMap policy) {
     ...
     * @return 生成的上传token
     */
    public String uploadToken(String bucket, String key, long expires, com.qiniu.util.StringMap policy, boolean strict) {
        long deadline = System.currentTimeMillis() / 1000 + expires;
    ...
    public String uploadTokenWithDeadline(String bucket, String key, long deadline, com.qiniu.util.StringMap policy, boolean strict) {
        ...
        com.qiniu.util.StringMap x = new com.qiniu.util.StringMap();
        copyPolicy(x, policy, strict);
        x.put("scope", scope);
        x.put("deadline", deadline);

        String s = Json.encode(x);
        return signWithData(com.qiniu.util.StringUtils.utf8Bytes(s));
    }
    ...
    @Deprecated
    public com.qiniu.util.StringMap authorization(String url, byte[] body, String contentType) {
        String authorization = "QBox " + signRequest(url, body, contentType);
        return new com.qiniu.util.StringMap().put("Authorization", authorization);
    }

    @Deprecated
    public com.qiniu.util.StringMap authorization(String url) {
    ...
    public String signQiniuAuthorization(String url, String method, byte[] body, Headers headers) {
        ...
        Mac mac = createMac();
        mac.update(com.qiniu.util.StringUtils.utf8Bytes(sb.toString()));
    ...
    @Deprecated
    public com.qiniu.util.StringMap authorizationV2(String url, String method, byte[] body, String contentType) {
        String authorization = "Qiniu " + signRequestV2(url, method, body, contentType);
        return new com.qiniu.util.StringMap().put("Authorization", authorization);
    }

    @Deprecated
    public com.qiniu.util.StringMap authorizationV2(String url) {
    ...
    public String generateLinkingDeviceToken(String appid, String deviceName, long deadline, String[] actions) {
        ...
        com.qiniu.util.StringMap map = new com.qiniu.util.StringMap();
